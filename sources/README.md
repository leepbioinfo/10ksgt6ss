...
2. The [Zenodo repository](https://zenodo.org/records/17968970) associated with this work, includes some very large files used by the script `genomes.py` (see below):
	1. 10ksgt6ss-9.zip: latest copy of our GitHub repository.
	...
	5. merged2.c100i100.fa.gz: non-identical set of protein sequneces of the 10K Salmonella genomes.
	6. domain.pkl.gz: hits to models of toxins and secretion system components.
...
- Code that requires changing file paths and/or download of publicily available data
  ...
  8. `step8.sh`: run our new toxin models against the 10KSG proteomes. These results were used to generate or Figure 1E.
